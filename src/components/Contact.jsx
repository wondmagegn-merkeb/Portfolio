  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://formsubmit.co/ajax/wondmagegnmerkebbeleka@gmail.com",
        {
          method: "POST",
          headers: {
          ...
          <div className="space-y-6">
            ...
            {contactInfo.map((info, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-16 h-16 rounded-xl bg-gradient-to-br ${info.color} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                  >
